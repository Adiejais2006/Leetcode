// Last updated: 9/15/2026, 6:03:42 PM
1class Solution {
2public:
...
25                    int neweffort = abs(heights[nx][ny] - heights[x][y]);
26                    int finaleffect = max(currenteffort, neweffort);
27                    if (dist[nx][ny] > finaleffect) {
28                        dist[nx][ny] = finaleffect;
